...
for (const starter of starters.slice(0, 20)) {
  for (const adv of adverbs) {
    for (const verb of shortVerbs.slice(0, 15)) {
      ...
      if (allReasons.length >= 1e4) break;
    }
    if (allReasons.length >= 1e4) break;
  }
  if (allReasons.length >= 1e4) break;
...
const reasons = shuffled.slice(
  0,
  Math.min(shuffled.length, 8e3)
);
reasons.length;
...
function BotanicalHero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "hero-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "botanical-top", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        viewBox: "0 0 800 200",
        ...
        "aria-hidden": "true",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { stroke: "#7a9e7e", strokeWidth: "1.5", fill: "none", opacity: "0.7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0 180 Q80 120 160 100" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M60 150 Q90 120 100 90" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M100 130 Q130 100 145 70" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { transform: "translate(400,160)", opacity: "0.6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "0", cy: "0", r: "5", fill: "#c9a84c" }),
            FLORAL_ANGLES.map((angle) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "ellipse",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-by", children: "by Sherry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-title", children: [
        "8,000 Reasons",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "I Love You," }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Merin"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-subtitle", children: "Every single one is true. Every single one is not enough." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "botanical-bottom", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        viewBox: "0 0 800 80",
        xmlns: "http://www.w3.org/2000/svg",
        "aria-hidden": "true",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { stroke: "#c4623a", strokeWidth: "1", fill: "none", opacity: "0.25", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M200 80 Q300 40 400 50 Q500 60 600 20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M280 70 Q310 50 320 30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M480 60 Q510 40 520 20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "ellipse",
            {
              cx: "300",
...
function Divider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      viewBox: "0 0 600 40",
      xmlns: "http://www.w3.org/2000/svg",
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "none", stroke: "#c4623a", strokeWidth: "1", opacity: "0.4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "0", y1: "20", x2: "240", y2: "20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "270",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "300", cy: "20", r: "6", fill: "none", stroke: "#c4623a" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "330",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "360", y1: "20", x2: "600", y2: "20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
            cx: "270",
...
function ReasonCard({ text, index: index2 }) {
  ...
  const style2 = cardStyles[index2 % cardStyles.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `reason-card ${style2} ${visible ? "reason-card--visible" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "reason-number", children: index2 + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reason-text", children: text })
      ]
    }
  );
}
function App() {
  const [visibleCount, setVisibleCount] = reactExports.useState(INITIAL_BATCH);
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && visibleCount < reasons.length) {
          setVisibleCount(
            (prev) => Math.min(prev + BATCH_SIZE, reasons.length)
          );
        }
      },
      { rootMargin: "400px" }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BotanicalHero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "main-content", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reasons-grid", children: visibleReasons.map((reason, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ReasonCard, { text: reason, index: i }, reason)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: sentinelRef, className: "sentinel", "aria-hidden": "true" }),
            visibleCount < reasons.length && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loading-indicator", "aria-live": "polite", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "loading-dot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "loading-dot" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "loading-dot" })
            ] })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "site-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "footer-botanical", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          viewBox: "0 0 400 60",
          xmlns: "http://www.w3.org/2000/svg",
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "#7a9e7e", opacity: "0.4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "ellipse",
                {
                  cx: "180",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "#d4a0a0", opacity: "0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "200", cy: "20", r: "4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "215", cy: "15", r: "3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "190", cy: "18", r: "3" })
            ] })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-closing", children: "And even 8,000 reasons isn't enough..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-love", children: "With all of me, always — Sherry ♡" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "footer-credit", children: [
        "© ",
...
Service({
  ...
  "incrementAndGetVisitorCount": Func([], [Nat], [])
});
